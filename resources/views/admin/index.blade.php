                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover no-margin">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$trades->currency_to_buy}}</td>
                                                <td>{{$trades->amount_to_buy}}</td>
                                                <td>@foreach($data as $taxes){{$taxes->tax}} @endforeach</td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td class="">{{$currency->ticker}}</td>
                                                <td class="">{{$currency->usd_rate}}</td>
                                                <td class="">{{$currency->buying_price}}</td>
                                                <td class="">{{$currency->selling_price}}</td>
                                                <td>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <h3>SET CRYPTOCURRENCY VARIABLES </h3>
                                        <div class="controls">
                                            <form action="#" method="post" >
                                                ...
                                                <button type="submit" name="submit" id="submit"
                                                        class="btn btn-primary btn-block btn-md" >SET  </button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
...
<!-- Crypto Admin App -->
<script src="{{asset('my_assets/js/template.js')}}"></script>

<!-- Crypto Admin dashboard demo (This is only for demo purposes) -->
<script src="{{asset('my_assets/js/pages/dashboard9.js')}}"></script>
<script src="{{asset('my_assets/js/pages/dashboard9-chart.js')}}"></script>

<!-- Crypto Admin for demo purposes -->
<script src="{{asset('my_assets/js/demo.js')}}"></script>
