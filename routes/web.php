...
Route::get('exchange_crypto', 'CurrencyController@currencyExchange');
//Route::post('exchange_crypto', 'CurrencyController@currencyExchangeCalculator');
Route::get('buy_crypto', 'InvoiceController@currencyBuy');
Route::get('sell_crypto', 'CurrencyController@currencySell')->name('sell_crypto');
Route::post('buy_crypto', 'InvoiceController@store');
Route::get('invoice_crypto', 'InvoiceController@printInvoice');
Route::post('invoice_sell_crypto', 'CurrencyController@currencySell');
Route::get('/admin_crypto/index', 'Admin_cryptoController@index');
//Route::post('/admin_crypto/index', 'Admin_cryptoController@store');
Route::get('/admin_crypto/auth_login', 'Admin_cryptoController@signIn');
//Route::get('/admin_crypto/auth_login', 'AdminAuthController@postSignin');//->name('auth_login');
